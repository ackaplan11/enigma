...
public class MovingRotorTest {
    ...
    private void checkMovingRotor(String testId,
    ...
    public void checkRotorAtA() {
        setMovingRotor("I", NAVALA, "");
        checkMovingRotor("Rotor I (A)", UPPER_STRING, NAVALA_MAP.get("I"));
    }
    ...
    public void checkRotorAdvance() {
        setMovingRotor("I", NAVALA, "");
        rotor.advance();
        checkMovingRotor("Rotor I advanced", UPPER_STRING, NAVALB_MAP.get("I"));
    }
    ...
    public void checkRotorSet() {
        setMovingRotor("I", NAVALA, "");
        rotor.set(25);
        checkMovingRotor("Rotor I set", UPPER_STRING, NAVALZ_MAP.get("I"));
    }
